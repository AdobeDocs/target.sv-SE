...
* Tänk på begränsningarna för filöverföringar, som beskrivs i [Om datafiler och datakällor för kundattribut](https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/crs-data-file.html?lang=en) i *Experience Cloud Central Interface Components Guide*. Bästa praxis:
...
Detaljerade instruktioner för hur du utför följande åtgärder finns i [Skapa en kundattributkälla och överför datafilen](https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/t-crs-usecase.html) i *Experience Cloud Services and Administration-dokumentationen*.
...
* [Skapa en kundattributkälla och överför datafilen](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/t-crs-usecase.html) i *Experience Cloud Services and Administration-dokumentationen*
