...
* Observera begränsningarna för filöverföringar som beskrivs i [Om datafiler och datakällor för kundattribut](https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/crs-data-file.html?lang=sv-SE) i *Experience Cloud Central Interface Components Guide*. Bästa praxis:
...
Detaljerade instruktioner för hur du utför följande åtgärder finns i [Skapa en kundattributkälla och överför datafilen](https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/t-crs-usecase.html?lang=sv-SE) i *Experience Cloud Services- och administrationsdokumentationen*.
...
1. Skapa attributkällan och överför datafilen.
   ...
   * **FTP:** Klicka på FTP-länken för att [överföra filen via FTP](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/t-upload-attributes-ftp.html?lang=sv-SE). Det första steget är att ange ett lösenord för FTP-servern som tillhandahålls av Adobe. Ange lösenordet och klicka sedan på **[!UICONTROL Done]**.
...
* [Skapa en kundattributkälla och överför datafilen](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/t-crs-usecase.html?lang=sv-SE) i *Experience Cloud Services och Administration-dokumentationen*
