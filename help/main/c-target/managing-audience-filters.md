...
description: Lär dig använda målgruppsfilter i [!DNL Adobe Target] för att visa data från besökare som delar egenskaper.
...
Målgruppsfilter (eller målgrupper) i [!DNL Adobe Target] är grupper av besökare som delar en specifik egenskap eller uppsättning egenskaper.
...
* **Målgrupper skapade från [!UICONTROL Audiences] kan återanvändas.** Målgrupper som skapats som en del av en aktivitet kan inte återanvändas.

I följande avsnitt finns mer information om hur du skapar och rapporterar om målgrupper:

| Uppgift | Ämne |
|--- |--- |
| Skapa lämplig aktivitet eller test. | [Verksamheter och tester](/help/main/c-intro/target-key-concepts.md) |
