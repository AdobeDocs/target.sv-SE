...
>
>Tidigare sparades aktiviteter först i användargränssnittet för [!DNL Target] och synkroniserades sedan till leveranssystemet för [!DNL Target], vilket krävde dessa mellanliggande tillstånd. Eftersom detta inte längre är fallet har dessa lägen tagits bort.
>
