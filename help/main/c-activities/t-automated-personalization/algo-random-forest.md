...
description: Se hur Adobe [!DNL Target] använder algoritmen Slumpmässig skog i både Automated Personalization (AP) och Auto-Target-aktiviteter.
...
# ![PREMIUM](/help/main/assets/premium.png) Slumpmässig skogsalgoritm
