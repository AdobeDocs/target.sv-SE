...
description: Lär dig använda [!UICONTROL Visual Experience Composer] (VEC) i Adobe [!DNL Target] för att skapa de erbjudanden du vill inkludera i [!UICONTROL Multivariate Test] (MVT).
...
>[!NOTE]
>
>Klicka **[!UICONTROL Expand Selection]** när du markerar objekt på sidan för att markera det överordnade elementet förutom det ursprungligen markerade elementet. När du markerar ett överordnat element markeras alla underordnade element automatiskt. Du kan expandera markeringen flera gånger.
>
...
1. Markera alla bilder som du vill ta med i testet och klicka sedan på **[!UICONTROL Save]**.
   ...
   ![Välj innehåll som används för att lägga till bilder](/help/main/c-activities/c-multivariate-testing/t-create-multivariate-test/assets/addimage.png)
