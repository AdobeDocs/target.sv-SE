...
description: Se hur Adobe [!DNL Target] avgör vilken aktivitet (eller vilka aktiviteter) som ska levereras till en sida på olika sätt beroende på vilken [!DNL Target] och vilken aktivitetsskapande funktion du använder.
...
## Target Standard/Premium Visual Experience Composer Only eller Form-Based Composer Using Global [!DNL Target] Endast begäran {#section_4A0A317DFED345649B58B0CB5B410C8B}
...
1. Målserveranropet kommer till Target med information om [!DNL Target] request och URL.
1. Target Classic och Standard drar alla aktiviteter som körs i det [!DNL Target] begäran.
1. Målförsök att matcha besökaren med aktiviteter.
...
## Målstandarddisposition/förstklassig formulärbaserad disposition med icke-global [!DNL Target] Begäranden {#section_C3F5F09B0B2D4EF795C5929D5C426A8C}
...
>[!NOTE]
>
>Beroende på dina inställningar varierar prioritetsvärdena. Du kan använda de äldre inställningarna Låg, Medel eller Hög, eller aktivera finkorniga prioriteringar mellan 0 och 999. Mer information finns i [Aktivitetsinställningar](/help/main/c-activities/activity-settings.md#task_C6B2FF8374724933BE79A83549B9CD02).
