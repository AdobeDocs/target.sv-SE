...
|  | [Överväganden och kända begränsningar](https://experienceleague.adobe.com/sv/docs/target-dev/developer/api/delivery-api/known-limitations){target=_blank} i *[!DNL Target]Utvecklarhandbok* | Information om att använda försiktighet har lagts till när [!DNL Recommendations] [!UICONTROL Catalogs] uppdaterades via [!DNL Target Delivery API]. |
