...
|--- |--- |--- |
| 18 augusti | [Analyser för målrapportering (A4T)](https://experienceleague.adobe.com/en/docs/target-dev/developer/server-side/integration/a4t-reporting){target=_blank} i *Utvecklarhandbok för mål* | Uppdaterade följande avsnitt:<ul><li>Kodfragmentet för GET-begäran har uppdaterats.</li><li>Frågesträngsparametrarna och variabeltabellen har uppdaterats.</li><li>Uppdaterade avsnittet *Exempel på infogning av A4T-data i HTTP Get call*.</li></ul> |
