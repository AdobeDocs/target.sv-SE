...
|--- |--- |--- |
| 19 september | [Adobe Target-anslutning](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/adobe-target-connection){target=_blank} i [!DNL Adobe Experience]-målguiden. | Följande anteckning har uppdaterats: *Datastream är unik i hela organisationen*. |
