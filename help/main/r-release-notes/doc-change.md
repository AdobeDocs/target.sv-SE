...
|  | [Översikt över leverans-API:t](https://experienceleague.corp.adobe.com/docs/target-dev/developer/api/delivery-api/overview.html){target=_blank} i *[!DNL Target]Utvecklarhandbok* | Viktig anteckning har lagts till. |
