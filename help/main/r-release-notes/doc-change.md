...
|--- |--- |--- |
| 21 juli | [[!DNL Target] Vanliga frågor och svar om gränssnittsuppdatering](/help/main/c-intro/updated-ui-faq.md#collapse) | Nya vanliga frågor och svar: Kan jag komprimera [!UICONTROL Components]- och [!UICONTROL Modifications]-skenorna så att jag kan förstora panelen [!UICONTROL Design]? |
