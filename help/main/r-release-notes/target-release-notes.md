...
## [!DNL Target] Standard/Premium 22.9.1 (version 6-8 september 2022)
...
* Ett problem har korrigerats för att säkerställa att kunderna kan redigera och ta bort objekt (design, villkor, samlingar o.s.v.) med [!DNL Target] Användargränssnitt i [!UICONTROL A/B Test] och [!UICONTROL Experience Targeting] (XT) aktiviteter som innehåller rekommendationer. (TGT-42331)
