...
+++Se detaljer
* **Korrigerat problem i rekommenderade[!DNL]ndations-gränssnitt där CSV-hämtning med anpassade villkor returnerade 404-fel**: Korrigerat ett problem där kunderna inte kunde hämta CSV-filen med anpassade villkor i processen för att skapa aktiviteter. Hämtningslänken fungerar nu korrekt, så att kunderna kan exportera anpassade villkor som förväntat. (TGT-51966)
