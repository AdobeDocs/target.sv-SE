...
Mer information finns i [Python SDK-dokumentation](https://developer.adobe.com/target/implement/server-side/python/) i [Adobe Target Developer Guide](https://developer.adobe.com/target/).
