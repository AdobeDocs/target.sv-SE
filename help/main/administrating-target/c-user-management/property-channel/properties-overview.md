...
1. [Klicka på fliken **[!UICONTROL Users]** längst upp på Admin Console ](/help/main/administrating-target/c-user-management/property-channel/properties-overview.md#section_79796E0227D048F59BAE0AB02E544EBE) > **[!UICONTROL Add Users]** om du vill skapa nya användare eller redigera befintliga användare. 
...
Du måste skicka arbetsytans ID för att kunna utnyttja företagsbehörigheter i [mål-API:er](https://experienceleague.adobe.com/docs/target-dev/developer/server-side/server-side-overview.html){target=_blank}.
...
1. Klicka på fliken **[!UICONTROL Users]** längst upp på Admin Console > **[!UICONTROL User Groups]** om du vill skapa nya användargrupper eller redigera befintliga grupper.
1. Följ anvisningarna i [Hantera användare och grupper för en produktkonfiguration](https://helpx.adobe.com/enterprise/help/manage-products-and-configurations.html) i *Enterprise-användarhandboken*.
...
1. (Villkorligt) Använd implementeringskoden som du genererade och sparade i Urklipp när du utför stegen i [4. Skapa egenskaper ](/help/main/administrating-target/c-user-management/property-channel/properties-overview.md#section_E8F2C92BE0F4466AB87604059C9CF3FD) och fortsätt till steg 2.
   ...
   1. Håll muspekaren över kolumnen [!UICONTROL Last Updated] om du vill att den egenskap som ska visas ska visas och klicka på ikonen [!UICONTROL Code] .
...
1. Uppdatera implementeringen av [!DNL Target] med implementeringskoden som hämtades i föregående steg.
   ...
   * **Via en anpassad parameter i taggar i [!DNL Adobe Experience Platform]:**
     ...
     Mer information finns i [Lägg till Mbox-parametrar](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/target/overview.html?lang=en#add-mbox-params) i *taggöversikten* -dokumentationen.
