...
Du måste skicka arbetsytans ID för att kunna utnyttja Enterprise Permissions i [Mål-API:er](/help/main/c-implementing-target/c-api-and-sdk-overview/api-and-sdk-overview.md).
...
1. Uppdatera dina [!DNL Target] implementering med den implementeringskod som erhölls i föregående steg.
   ...
   * **Via funktionen targetPageParamsAll():** Placera följande kod i `<head>` -taggar, ovanför referensen at.js.
      ...
      Mer information om hur du gör detta med at.js finns i [targetPageParamsAll](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/targetpageparamsall.md).
