...
Du måste skicka arbetsytans ID för att kunna utnyttja Enterprise Permissions i [Mål-API:er](https://developer.adobe.com/target/implement/server-side/).
...
1. Uppdatera dina [!DNL Target] implementering med den implementeringskod som erhölls i föregående steg.
   ...
   * **Via funktionen targetPageParamsAll():** Placera följande kod i `<head>` -taggar, ovanför referensen at.js.
      ...
      Mer information om hur du gör detta med at.js finns i [targetPageParamsAll](https://developer.adobe.com/target/implement/client-side/atjs/atjs-functions/targetpageparamsall/).
