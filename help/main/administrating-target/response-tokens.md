...
1. Kontrollera att du använder Platform Web SDK version 2.6.0 (eller senare) eller at.js version 1.1 (eller senare).
   ...
   * **at.js**: Se [Ladda ned på.js](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/implementing-target-without-a-tag-manager.md#concept_1E1F958F9CCC4E35AD97581EFAF659E2).
...
Använd [at.js, anpassade händelser](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/atjs-custom-events.md) att lyssna efter [!DNL Target] svara och läsa svarstoken.
