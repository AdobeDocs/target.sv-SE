...
|--- |--- |--- |--- |
| `client_code` | *client_code* | Kundens kod som används i Rekommendationer. Din Adobe-konsult kan ge det här värdet. |  |
...
## Metod 3: Använd API för hämtning av rekommendationer {#download-api}
