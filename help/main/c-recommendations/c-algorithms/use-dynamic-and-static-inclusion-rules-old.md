...
description: Lär dig skapa inkluderingsregler i Adobe [!DNL Target] Recommendations för villkor och kampanjer. För att få bättre resultat lägger du till mer dynamiska eller statiska filtreringsregler.
...
Klicka **[!UICONTROL Add Filtering Rule]** under **[!UICONTROL Inclusion Rules]** när du [skapar villkor](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md#task_8A9CB465F28D44899F69F38AD27352FE).
