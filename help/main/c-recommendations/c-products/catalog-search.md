...
1. Ange ett sökord i **[!UICONTROL Search Products]** fält.
...
Du kan skapa [samlingar](/help/main/c-recommendations/c-products/collections.md) eller [undantag](/help/main/c-recommendations/c-products/exclusions.md) använda [!UICONTROL Advanced Search] på [!UICONTROL Catalog Search] sida ([!UICONTROL Recommendations] > [!UICONTROL Catalog Search] > [!UICONTROL Advanced Search]).
...
Du kan tillfälligt ändra de tillgängliga filtren och kolumnerna på [!UICONTROL Catalog Search] sida för den aktuella sessionen.
