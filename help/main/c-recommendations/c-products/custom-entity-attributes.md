...
Information om hur du använder enhets-API:erna Delivery och Save finns i [Adobe Recommendations API-dokumentationen](https://experienceleague.adobe.com/docs/target-dev/developer/recommendations.html?lang=sv-SE){target=_blank}.
