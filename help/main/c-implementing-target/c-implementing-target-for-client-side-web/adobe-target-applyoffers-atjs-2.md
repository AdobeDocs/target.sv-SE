...
>[!NOTE]
>
>Läs [Dokumentation för leverans-API](https://developer.adobe.com/target/before-administer/){target=_blank} om du vill ha information om de tillåtna typerna för alla fält som listas nedan.
