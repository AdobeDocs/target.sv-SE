...
![Traditionell livscykel jämfört med SPA ](/help/main/c-experiences/assets/trad-vs-spa.png)
...
## Vyer och program för en sida i Adobe [!DNL Target]
...
## Implementerar Adobe [!DNL Target]-vyer
...
1. Eftersom din webbplats är en SPA utför du ingen sidinläsning utan dirigerar användaren till `http://www.telecom.com/loggedIn/home`.
...
| [Recommendations som ett erbjudande](/help/main/c-recommendations/recommendations-as-an-offer.md)<br>i A/B Test and Experience Targeting-aktiviteter (XT) | Ja |
...
Om du vill få tillgång till alternativen för [!UICONTROL Page Delivery] i VEC:s tredelade guidade arbetsflöde för att skapa aktivitet klickar du på **[!UICONTROL Configure]** (kugghjulsikonen) > **[!UICONTROL Page Delivery]** i **[!UICONTROL Experiences]** -steget.
...
Eftersom SPA fungerar på ett annat sätt måste inställningarna för [!UICONTROL Page Delivery] konfigureras så att alla åtgärder kan tillämpas på vyerna enligt SPA VEC-aktivitet.
...
Mer information finns i [Använda Visual Experience Composer för enkelsidigt program (SPA VEC) i Adobe Target](https://helpx.adobe.com/target/kt/using/visual-experience-composer-for-single-page-applications-feature-video-use.html).
