...
[!UICONTROL Visual Experience Composer] (VEC) i [!DNL Adobe Target] är en WYSIWYG-redigerare som gör att kunder kan skapa och testa personaliserade upplevelser direkt på sina webbplatser eller på mobilwebbsidor utan att behöva redigera kod.

>[!NOTE]
>
>Versionen [!DNL Target Standard/Premium] 25.2.1 (17 februari 2025) innehöll en uppdaterad version av VEC. Mer information om hur den uppdaterade VEC skiljer sig från den tidigare versionen finns i [Ändringar i Visual Experience Composer](/help/main/c-experiences/c-visual-experience-composer/vec-changes.md). En översikt över de olika alternativen i den uppdaterade VEC:n finns i [Alternativ för Visual Experience Composer](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md).

Med VEC kan ni enkelt skapa och testa personaliserade upplevelser och erbjudanden i webbplatskontexten. Du kan skapa upplevelser och erbjudanden för [!DNL Target]-aktiviteter genom att dra och släppa, byta och ändra layouten och innehållet på en webbsida (eller ett erbjudande) eller en mobilwebbsida.

VEC är en av huvudfunktionerna i [!DNL Target]. Med VEC kan marknadsförare och designers skapa och ändra innehåll med ett visuellt gränssnitt. Många designalternativ kan göras utan att koden behöver redigeras direkt. Det går också att redigera HTML och JavaScript med de redigeringsalternativ som finns i dispositionen.

På fliken [!DNL Target] **[!UICONTROL Administration]** > **[!UICONTROL Visual Experience Composer]** kan du ange standardwebbadressen för [!UICONTROL Visual Experience Composer].

Den här URL:en avgör var du börjar när du öppnar VEC. Om du inte anger någon standardwebbadress (URL) börjar du med en tom sida när du öppnar redigeraren och anger sedan en webbadress.
...
Du kan använda flikarna i fältet [!UICONTROL Experiences] för att visa sidan så som den skulle visas för olika målgrupper eller med olika upplevelser. Du kan ange ett namn för varje upplevelse. Om du till exempel testar platsen för länken Hem i navigeringsfältet kan du namnge en upplevelse där länken Hem visas först. Exempel:&quot;Hemlänk&quot; för att göra det enklare att identifiera upplevelserna i listan.
...
Klicka på ett markerat element om du vill se en meny med alternativ för den elementtypen. Du kan till exempel klicka på en bild och välja **[!UICONTROL Change Image]** om du vill ändra bilden till en annan bild. Eller klicka på en knapp och ändra textfärgen.
...
När sidan läses in (eller när den inte kan läsas in) är alternativen [!UICONTROL Experiences], [!UICONTROL Components] räl och [!UICONTROL Configure] tillgängliga.
...
* Du vill lägga till fler malltestningsregler i villkoren för [!UICONTROL Page Delivery]
* Du vill åsidosätta den globala växeln [!UICONTROL Enhanced Experience Composer] (EEC) när du läser in en sida via EEC eller iframe

Om du avbryter sidinläsningen i VEC kan du växla mellan upplevelserna i aktiviteten utan att vänta på att sidan ska läsas in. Om du vill visa sidan i VEC igen måste du klicka på knappen **[!UICONTROL Reload]**.
