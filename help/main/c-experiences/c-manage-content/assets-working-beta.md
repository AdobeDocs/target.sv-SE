...
description: Lär dig hur du hanterar kod och bilderbjudanden i [!DNL Target] [!UICONTROL Offers] bibliotek.
title: Hur arbetar jag med innehåll i [!UICONTROL Offers] Bibliotek?
...
Information om de uppgifter du kan utföra på en resurs i innehållsbiblioteket i [!DNL Adobe Target] inklusive anteckningar, kopiering, borttagning, hämtning, redigering, delning och visningsegenskaper.

1. Klicka **[!UICONTROL Offers]** > **[!UICONTROL Code Offers]** eller **[!UICONTROL Image Offers]**.
...
1. (Valfritt) Växla mellan [!UICONTROL Card View] och [!UICONTROL List View]klickar du på [!UICONTROL Card View] ikonen eller [!UICONTROL List View] i det övre högra hörnet av innehållsbiblioteket. Du kan också använda [!UICONTROL View Settings] om du vill konfigurera kolumnerna ytterligare när du visar [!UICONTROL List View].
...
När du visar [!UICONTROL Code Offers] kan du utföra följande åtgärder på ett objekt genom att hålla markören över ett erbjudande eller en mapp och sedan välja lämplig ikon.
...
* **Flytta**: Klicka på ikonen Flytta, navigera till den plats där du vill flytta erbjudandet eller mappen och klicka sedan på **[!UICONTROL Drop]** -ikon. Du kan till exempel flytta en eller flera mappar till en annan mapp för att skapa undermappar. Klicka [!UICONTROL Clear Selection] om du vill avmarkera erbjudanden eller mappar som du har markerat.
* **Ta bort**: Ta bort erbjudandet eller mappen. Se [Att tänka på när du tar bort objekt](#delete).

## Alternativ för bilderbjudanden

När du visar [!UICONTROL Image Offers] kan du utföra följande åtgärder på ett objekt genom att hålla markören över ett erbjudande eller en mapp och sedan välja lämplig ikon.
...
* **Välj**: Välj en eller flera mappar som du vill utföra följande åtgärder på:
