...
title: Lär dig hur du skapar mappar i Adobe [!DNL Target] Erbjuder bibliotek med kod och bilderbjudanden, liksom andra mappar.
...
1. (Valfritt) Välj **[!UICONTROL Private]** kryssruta.

   Anger att mappen är privat så att bara du kan se den och dess innehåll.

1. (Valfritt) Välj **[!UICONTROL Reorder-able in List View]** kryssruta.
