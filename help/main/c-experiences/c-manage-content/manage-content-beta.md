...
| Kryssrutor för gruppåtgärd<P>![Ikon för gruppåtgärd](/help/main/assets/icons/Selection.svg) | Klicka på kryssrutorna [!UICONTROL Bulk Operations] om du vill utföra gruppåtgärder för alla aktiviteter eller för valda aktiviteter.<P>En lista med tillgängliga åtgärder (beroende på dina behörigheter och erbjudandestatus) finns i [Utför snabbåtgärder](#quick-actions) nedan. |
