...
1. Nästa till **[!UICONTROL Target Preset]** klickar du på ikonen för tre lodräta ellipser > **[!UICONTROL Save as New]**.
...
1. Granska informationen i **[!UICONTROL Filters]** och **[!UICONTROL Settings]** för att säkerställa att rapporten är konfigurerad som du vill ha den anger du **[!UICONTROL Preset Name]** (upp till 50 tecken).
1. (Villkorligt) Om du vill att det här ska vara din standard-/favoritrapportvy drar du i rutan **[!UICONTROL Set as default preset]** växla till På-position.
1. Klicka på **[!UICONTROL Save]**.

### Välj en annan förinställning

Välj önskad förinställning på menyn **[!UICONTROL Target Preset]** nedrullningsbar lista.

![Listruta för förinställning](/help/main/c-reports/c-report-settings/assets/report_preset_drop-down-new.png)
...
1. Klicka på ikonen för tre lodräta ellipser > **[!UICONTROL Save as New]** för att skapa en ny förinställning.
   ...
   Klicka på ikonen för tre lodräta ellipser > **[!UICONTROL Update]** om du vill uppdatera den aktuella förinställningen.

   ![Standarduppdatering för rapport](/help/main/c-reports/c-report-settings/assets/report_preset_update-new.png)
...
1. Klicka på ikonen för tre lodräta ellipser > **[!UICONTROL Delete]**.
   ...
   ![Standardredigering för rapport](/help/main/c-reports/c-report-settings/assets/report_preset_delete-new.png)
...
Klicka på **[!UICONTROL Report Metric]** nedrullningsbar lista där du kan välja en annan [framgångsmått](/help/main/c-activities/r-success-metrics/success-metrics.md#reference_D011575C85DA48E989A244593D9B9924) eller flera mätvärden som ska visas i diagrammet.
...
Mer information om hur du väljer flera mätvärden att visa i rapporter finns i [Visa flera mått i en rapport](/help/main/c-reports/c-report-settings/view-multiple-metrics.md#concept_9E3C3F6F3EC1412FAF252975AC0720B7).

## Målgrupp {#section_70926EB4618945D9AFF2B0564FF3717B}

Klicka på [!UICONTROL Audience] nedrullningsbar lista för att ändra rapportens visade målgrupp.

Mer information finns i [Målgrupper](/help/main/c-target/target.md#concept_A782F8481A5041EBA75103CB26376522).
...
Välj ny **[!UICONTROL Start]** och **[!UICONTROL End]** datum för rapporten. Du kan också använda **[!UICONTROL From start of Activity]** och **[!UICONTROL Till end of Activity]** kryssrutor.
...
The [!UICONTROL Exclude Extreme Values] gäller endast för aktiviteter med måtten Intäkter och engagemang. Mer information finns i [Exklusive extrema order](/help/main/c-reports/c-report-settings/excluding-extreme-orders.md#task_2AE7743FFCDD466DAEEB720BE5F33DAA).

## Hämta {#section_77E65C50BAAF4AB79242DB3A8778ADEF}

Klicka på **[!UICONTROL Download]** ikon för att ladda ned rapportdata i en [!DNL .csv] format för snabb import till Excel, Access eller andra dataanalysprogram.
...
Klicka på **[!UICONTROL Refresh]** om du vill uppdatera en rapports tabell- och diagramvy utan att uppdatera hela sidan, dess konfiguration eller dess datumintervall.

## Fler alternativ {#section_AB1B5C695D7045A0A0AC0E2698D2E7DE}

Klicka på ikonen Fler alternativ (tre lodräta ellipser) för att komma åt [!UICONTROL Edit Activity] och [!UICONTROL View Experience URLs] alternativ.
...
* **Tabellvy**: Klicka på **[!UICONTROL Table View]** om du vill visa rapporten som en tabell.
* **Diagramvy**: Klicka på **[!UICONTROL Graph View]** om du vill visa rapporten som ett diagram.
* **Automatiska segment**:(Endast tillgängligt för Automated Personalization- (AP) och AT-aktiviteter.) Klicka på **[!UICONTROL Automated Segments] -ikonen för att visa [Rapport över automatiserade segment](/help/main/c-reports/c-personalization-insights-reports/automated-segments-report.md).
* **Viktiga attribut**: (Endast tillgängligt för Automated Personalization-aktiviteter (AP) och Automatiskt mål-aktiviteter (AT).) Klicka på **[!UICONTROL Important Attributes] -ikonen för att visa [Viktiga attributrapporter](/help/main/c-reports/c-personalization-insights-reports/important-attributes-report.md).
...
* Den här funktionen är inte tillgänglig för aktiviteter som använder [Analyser som rapportkälla (A4T)](/help/main/c-integrating-target-with-mac/a4t/a4t.md).

## Platsbidrag {#section_5832F126AC114AE1ABFFF4D9B904393B}

Klicka på **[!UICONTROL Location Contribution]** om du vill växla rapporten för att visa bidrag per plats.
...
![Genomsnittlig rapportkörning](/help/main/c-reports/c-report-settings/assets/report_running_average-new.png)
...
Så här öppnar du [!UICONTROL Counting Methodology] när du visar en rapport i diagramläge klickar du på **[!UICONTROL My Primary Goal]** och välj beräkningsmetod.

Beräkningsmetoden är densamma som den som valts i [!UICONTROL Settings] som beskrivs ovan.

![Räkningsmetod](/help/main/c-reports/c-report-settings/assets/counting_methodology_2-new.png)

Som standard är diagrammet ritat i [!UICONTROL Daily] läge.

Du kan ändra läge genom att klicka på knappen [!UICONTROL Daily] och sedan välja ett kumulativt alternativ.
...
* För [Automatisk målgruppsaktiviteter](/help/main/c-activities/auto-target/auto-target-to-optimize.md), finns det inget alternativ för att välja&quot;Besökare&quot; som beräkningsmetod. Automatiskt mål är den enda aktivitetstypen som du inte kan rita upp av besökare.
* För aktiviteter som använder [Analyser som rapportkälla (A4T)](/help/main/c-integrating-target-with-mac/a4t/a4t.md)kan du inte rita besökare, besök eller Impression tillsammans.
