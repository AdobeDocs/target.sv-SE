...
1. Efter 15 dagar från det att aktiviteten aktiverats klickar du på **[!UICONTROL Important Attributes]** -ikon.
...
1. Välj önskat datumintervall.
   ...
   Du kan komma åt de tillgängliga fasta datumintervallen från [!UICONTROL Choose Duration] listruta.
...
1. Granska [!UICONTROL Important Attributes] rapportdata.
   ...
   ![Viktiga attribut-rapport i Adobe Target](/help/main/c-reports/assets/model_attribute_ranking_report.png)
