...
description: Låt oss komma igång med din första aktivitet i Adobe [!DNL Target] så att ni kan få avkastning på er investering.
...
Du kan skapa en grundläggande [A/B-testaktivitet](/help/main/c-activities/t-test-ab/test-ab.md) där du testar en variation av ett erbjudande eller en upplevelse mot en eller flera andra varianter för att se vilka som besökarna föredrar. Om du bara letar efter den vinnande varianten kan du välja att utnyttja AI för att få snabbare resultat genom att välja [Automatisk allokering](/help/main/c-activities/automated-traffic-allocation/automated-traffic-allocation.md) i det andra steget i arbetsflödet för A/B-testkonfiguration.
...
Du kan konfigurera en [Experience Targeting](/help/main/c-activities/t-experience-target/experience-target.md) (XT) är en aktivitet som riktar sig till en viss målgrupp som du känner till värdefull med ett erbjudande eller en upplevelse som du känner till skulle få dem att smälta.
...
Markera rutan för den aktivitetstyp som du vill köra. Du kan granska [Målaktivitetstyper](/help/main/c-activities/target-activities-guide.md) eller [Adobe Target i korthet](/help/main/c-intro/target-welcome-kit-2.md) för att förstå de olika typerna av tillgängliga aktivitetstyper.
