...
description: Använd mallen Sammanfattningsresultat för att kommunicera dina framgångar med dina Adobe [!DNL Target] aktiviteter.
title: Hur delar jag resultaten av Mina [!DNL Target] aktiviteter med Min organisation?
feature: Overview
...
# Kapitel 8: Kommunicera aktivitetsresultaten

Om du har en aktivitet och får fantastiska resultat måste du dela dessa resultat med organisationen. Ni kanske just har skaffat fler kunder, ökat intäkterna, sparat pengar genom att minska samtalscentret eller ökat det genomsnittliga ordervärdet. Visa för intressenter vad du kan uppnå för företaget genom att optimera och personalisera med [!DNL Target].
