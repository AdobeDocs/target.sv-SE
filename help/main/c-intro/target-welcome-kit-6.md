...
| Pitfall | Lösning |
| --- | --- |
| Inte tillräckligt med trafik för att uppnå statistiskt signifikanta resultat. | Använda Adobe Target [exempelstorlekskalkylator](https://experienceleague.adobe.com/tools/calculator/testcalculator.html) i förväg för att förstå hur länge testet måste köras och sedan köra testet tills det är klart. |
...
| En aktivitet före resultaten är statistiskt signifikant. | Verifiera testets varaktighet med Adobe [exempelstorlekskalkylator](https://experienceleague.adobe.com/tools/calculator/testcalculator.html). |
