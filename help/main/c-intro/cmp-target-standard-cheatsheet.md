...
**Var kan jag lära mig mer om de senaste målfunktionerna?**
...
Mer information finns i matrisen [Webbläsare som stöds](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/supported-browsers.html){target=_blank}. Observera att det finns två aspekter: gränssnittsstödet för Target Standard/Premium Experience Cloud och webbläsarstödet för slutanvändare på datorer/enheter.
...
**Kan jag göra en ändring av bara målsteget och inte gå igenom hela det guidade trestegsarbetsflödet för redigering?**
...
**Jag har också Adobe Analytics och vill använda det med Target. Vilka nyckelfunktioner får jag genom att integrera de två lösningarna?**
...
**Kan jag testa Visual Experience Composer (VEC) på min webbplats trots att biblioteket Target at.js ännu inte har distribuerats?**
...
**Jag har flera domäner. En av domänerna måste ha Förbättrad Experience Composer aktiverat, medan andra måste ha det inaktiverat. Hur kan jag göra det här?**
...
**Varför kan jag inte gå förbi inloggningssidan i Visual Experience Composer (VEC) eller till en sida som är nedgrävd och som jag inte har någon specifik URL för?**
...
Det är här [Analyser för mål (A4T)](/help/main/c-integrating-target-with-mac/a4t/a4t.md#concept_7540C8C04259434AB6EE33B09F47A1DE) är användbart. Om du har Adobe Analytics väljer du bara källan som Analytics, vilket eliminerar den här begränsningen. Nu kan ni göra analyser för alla typer av målgrupper, och ni behöver inte definiera de rapporterande målgrupperna direkt.

**Kan jag utföra offlinerapporteringsberäkningar?**

Använd alternativen [Exportera rapporter till CSV och Hämta beställningsinformation till CSV ](/help/main/c-reports/c-report-settings/downloading-data-in-csv-file.md) på rapportsidan för att hämta önskade rapportdata.

**Kan jag ändra kontrollupplevelsen för utvärdering av rapporter eller ändra beräkningsmetoden från besökare till besök?**
...
**Kan jag utföra en integrering med ett tredjepartssystem, som Google Analytics eller ClickTale, för att skicka aktivitetsinformationen som skickas till en slutanvändare för analys?**
