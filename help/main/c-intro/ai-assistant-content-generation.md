---
keywords: hjälpmedel;artificiell intelligensassistent;innehållsgenerering;innehållsaccelerator
...
Använd AI Assistant i Target för att förbättra effektiviteten i era aktiviteter genom att skräddarsy textutdrag och välja bilder som talar direkt till er målgrupp, vilket ökar engagemanget och interaktionen.
...
1. (Valfritt) Klicka på ikonen **Helskärm ( ![ Helskärm-ikon ](/help/main/assets/icons/FullScreen.svg) )** för att expandera [!DNL AI Assistant].

1. Beskriv texten som du vill generera i rutan **[!UICONTROL Prompt]**.

   Om du till exempel har en säsongssemester kan du skriva&quot;Write hero text advertising a limited-time sommar sales&quot;.
...
1. Klicka på ikonen **[!UICONTROL Text Settings]** för att ange textens ton och kommunikationsstrategi.
   ...
   * **Ton**: Textens ton ska tolkas som målgruppen. Oavsett om du vill låta informativ, lekfull eller övertygande kan [!DNL AI Assistant] anpassa meddelandet efter det.

1. Använd skjutreglaget för att välja textlängd ([!UICONTROL Shorter Text] till [!UICONTROL Larger Text]).

1. Klicka på **[!UICONTROL Generate]** om du vill skapa en lista med möjliga textvarianter.
