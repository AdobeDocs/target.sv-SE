...
[!DNL Real-Time Customer Data Platform] (RTCDP) som bygger på [!DNL Adobe Experience Platform] hjälper företag att samla in kända och anonyma data från flera företagskällor. Med RTCDP kan ni skapa kundprofiler som kan användas för att leverera personaliserade kundupplevelser över alla kanaler och enheter i realtid.
...
* [Adobe Target-anslutning](https://experienceleague.adobe.com/docs/experience-platform/destinations/catalog/personalization/adobe-target-connection.html){target=_blank} i guiden *Målöversikt*
...
* [Anpassa samma sida och nästa sida via  [!DNL Adobe Target] och anpassade Personalization-mål](https://experienceleague.adobe.com/docs/experience-platform/destinations/destinations-faq.html?lang=en#same-next-page-personalization){target=_blank} under Vanliga frågor och svar i guiden *Destinationsöversikt*.
