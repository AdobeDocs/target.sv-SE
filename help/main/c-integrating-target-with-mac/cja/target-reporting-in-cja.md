...
* Om du har frågor om timing kan du läsa [Fördröjningsöverväganden](https://experienceleague.adobe.com/sv/docs/analytics-platform/using/cja-overview/cja-faq#latency){target=_blank} i *Vanliga frågor* i *[!DNL Adobe Customer Analytics]handboken*.
...
1. Konfigurera din [anslutning och dina datainställningar](https://experienceleague.adobe.com/sv/docs/analytics-platform/using/cja-connections/overview){target=_blank} med rätt information.
