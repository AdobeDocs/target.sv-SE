...
>
>* Om du valde [!UICONTROL Use a CJA Metric] som aktivitetens målmått kan du med det här alternativet definiera mått för framgång senare. Eftersom ett [!DNL Customer Journey Analytics]-framgångsmått inte har valts förrän panelen [!UICONTROL Experimentation] har konfigurerats, kan en färdig rapport inte vara tillgänglig i ADV eftersom [!DNL Customer Journey Analytics] inte skulle veta vilket mätvärde som konverteringsgrader ska beräknas och härleda.
