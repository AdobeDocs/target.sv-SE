...
**Senast uppdaterad: 29 maj 2025 ( [Dokumentationsuppdateringar: se vad som ändrats](r-release-notes/doc-change.md) )**

>[!BEGINTABS]

>[!TAB Nyheter]

**[!DNL Target]25.5.4 är live!**

Uppdateringen släpptes 29 maj 2025 och innehåller nya förbättringar av användargränssnittet och viktig dokumentation. Gör en djupdykning och se vad som är nytt!
...
[!DNL AI Assistant] är din smarta guide till navigering i [!DNL Adobe Experience Cloud]. [!DNL AI Assistant] finns i produkter som [!DNL Target] och hjälper dig att snabbt förstå viktiga koncept och funktioner - direkt från gränssnittet.

[![Ikonen Läs mer](/help/main/assets/learn-more.svg)](/help/main/c-intro/ai-assistant.md)

>[!TAB Måldokumentation]

Förutom den här guiden finns även följande [!DNL Adobe Target] stödlinjer tillgängliga:

- [[!UICONTROL Adobe Target Developer Guide]](https://experienceleague.adobe.com/sv/docs/target-dev/developer/overview){target=_blank}
- [[!UICONTROL Adobe Target Tutorials]](https://experienceleague.adobe.com/sv/docs/target-learn/tutorials/overview){target=_blank}

>[!ENDTABS]

>[!IMPORTANT]
>
>Distributionen av det nya användargränssnittet för [!DNL Target] slutfördes den 27 maj 2025. Alla kunder har nu tillgång till den senaste gränssnittsversionen. Från och med 22 juni 2025 tas versionsväxeln för användargränssnittet bort. Alla användare kommer att övergå permanent till det nya gränssnittet, utan möjlighet att återgå till den tidigare versionen. Mer information finns i [Växla borttagning av målgränssnittsversion](/help/main/r-release-notes/release-notes.md#toggle).
