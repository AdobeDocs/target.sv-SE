...
**Senast uppdaterad: 26 februari 2025 ( [Se vad som ändrats](r-release-notes/doc-change.md) )**
...
- [Adobe Target självstudiekurser](https://experienceleague.adobe.com/docs/target-learn/tutorials/overview.html): Tillhandahåller självstudiekurser och videoklipp som hjälper dig att få ut så mycket som möjligt av Target.
