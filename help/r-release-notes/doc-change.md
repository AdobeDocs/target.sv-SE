...
description: På den här sidan visas viktiga ändringar som gjorts i dokumentationen för Adobe Target. Ändringarna är ordnade efter lanseringar.
...
| --- | --- | --- |
| 4 augusti | [Target notiser och event](/help/r-release-notes/target-announcements.md) | Lagt till registreringsinformation om webbseminariet&quot;Personalization Strategies Using Artificial Intelligence and Adobe Target&quot; som ska läggas in den 13 augusti. |
...
| Datum | Ämne | Ändringar |
| --- | --- | --- |
| 17 juli | [Target notiser och event](/help/r-release-notes/target-announcements.md) | Information om Adobe Target Coffee Break från 22 juli har lagts till. |
...
| 14 juli | [Automatisk allokering](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md),<br>[Automatisk Target](/help/c-activities/auto-target-to-optimize.md)<br><br>[och Automatiserad personalisering - frågor och svar](/help/c-activities/t-automated-personalization/automated-personalization-faq.md) | Vanliga frågor och svar har lagts till som rekommenderar att du inte ska ändra målmåttet genom en aktivitet. |
...
| 4 juni | [A4T-rapportering](/help/c-integrating-target-with-mac/a4t/reporting.md) | Uppdaterade avsnittet Rapporter i Analytics. |
...
|  | [Versionsinformation för Target (prerelease)](/help/r-release-notes/target-release-notes.md) | Ändrad till 6 maj för Target Standard-/Premium-versionen (20.4.1). |
...
| 20 mars | [Versionsinformation (aktuell)](/help/r-release-notes/release-notes.md) | Anger att Target Standard/Premium 20.2.1-utgåvan kommer att vara 23 mars 2020. |
