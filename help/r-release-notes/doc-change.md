...
| 28 oktober | [Serversida: implementera mål](/help/c-implementing-target/c-api-and-sdk-overview/api-and-sdk-overview.md) | Observera att förstagångsbesökare bara kan initieras på klientsidan, inte på serversidan. |
| 27 oktober | [Serversida: implementera mål](/help/c-implementing-target/c-api-and-sdk-overview/api-and-sdk-overview.md) | En länk har lagts till i den nya *[Adobe Target SDK:n](https://adobetarget-sdks.gitbook.io/docs/)*-portalen. |
...
|  | [Analyser för Target-implementering](/help/c-integrating-target-with-mac/a4t/a4timplementation.md) | Information som anger att du även måste vidarebefordra sessions-ID för [!UICONTROL Auto-Allocate]- och [!UICONTROL Auto-Target]-aktiviteter som använder `analyticsLogging = client_side`. |
...
| Datum | Ämne | Ändringar |
| --- | --- | --- |
| 26 oktober | [Översikt över målsäkerhet](/help/c-implementing-target/c-considerations-before-you-implement-target/target-security-overview.md) | *Adobe Target Security Overview* whitepaper har uppdaterats. |
...
| Datum | Ämne | Ändringar |
| --- | --- | --- |
| 29 september | [Felsöka integreringen med Analytics och Target (A4T)](/help/c-integrating-target-with-mac/a4t/c-a4t-troubleshooting/a4t-troubleshooting.md#section_75002584FA63456D8D9086172925DD8D) | Ytterligare information om hur du inspekterar det kompletterande ID:t i at.js 1.x och at.js 2.x har lagts till. |
...
|  | [Katalogsökning](/help/c-recommendations/c-products/catalog-search.md#faq) | En anteckning om sökning efter ett anpassat attribut med ett numeriskt värde har lagts till. |
|  | [Recommendations FAQ](/help/c-recommendations/c-recommendations-faq/recommendations-faq.md) | Följande frågor och svar har lagts till: &quot;Varför visas inte rätt resultat vid katalogsökning när jag söker efter ett anpassat attribut med ett numeriskt värde?&quot; |
|  | [Så här fungerar Target](/help/c-intro/how-target-works.md#concept_0AE2ED8E9DE64288A8B30FCBF1040934) | Uppdaterade platserna för målklustret och målklustret i listan i gränsnätverket. |
...
|  | [Skapa villkorssekvenser](/help/c-recommendations/c-algorithms/create-criteria-sequence.md) | Lagt till information om funktionen &quot;Begränsa antalet returnerade objekt&quot;. |
| 9 september | [Activity QA bookmarklet](/help/c-activities/c-activity-qa/activity-qa-bookmark.md) | Lagt till JavaScript-kod för användning med at.js 2.*x*. |
...
| 14 augusti | [Kända problem och lösta problem](/help/r-release-notes/known-issues-resolved-issues.md) | Ett känt problem med kvalitetskontrollen har lagts till i Recommendations-aktiviteter. |
|  | [targetGlobalSettings()](/help/c-implementing-target/c-implementing-target-for-client-side-web/targetgobalsettings.md) | Text som anger att om du använder `serverState` och `<script>`-taggar i det returnerade innehållet måste du se till att HTML-innehållet använder `<\/script>` i stället för `</script>`. |
| 12 augusti | [Förstå målgränssnittet](/help/c-intro/understand-the-target-ui.md) | Nytt ämne. |
|  | [Adobe Target API - översikt](/help/api/api-overview.md) | Nytt ämne. |
...
|  | [Aktivera blandat innehåll i webbläsaren](/help/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/mixed-content.md) | Uppdaterat ämne. |
| 3 augusti | [Framgångsmått](/help/c-activities/r-success-metrics/success-metrics.md) | En kommentar som klargör vad [!UICONTROL Increment Count]-alternativen betyder för besökare jämfört med besök har lagts till. |
...
|  | [adobe.target.getOffers(options) - at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Kodexempel har lagts till för att använda `getoffers()` för att utföra pageLoad. |
...
|  | [Kundattribut](/help/c-target/c-visitor-profile/working-with-customer-attributes.md) | Uppdaterat följande stycke:<br>[!DNL Adobe] garanterar inte att 100 % av kundattributdata (besökarprofil) från CRM-databaser kommer att sparas i [!DNL Experience Cloud] och därför vara tillgängliga för målinriktning i [!DNL Target]. I vår nuvarande design finns det en möjlighet att en liten andel data (upp till 0,1 % av stora tillverkningssatser) inte tas med. |
| 27 juli | [Administrera mål](/help/administrating-target/administrating-target.md) | Texten i alla länkade avsnitt på den här sidan har uppdaterats för att återspegla de nya gränssnittsändringarna för [!UICONTROL Administration]-sidorna. |
|  | [Målmeddelanden och evenemang](/help/r-release-notes/target-announcements.md) | Gör följande ändringar: <ul><li>Lagt till registreringsinformation för följande webbinarium: &quot;Hur HSBC utnyttjar Adobe Target och AI för att snabbt optimera och leverera personalisering i stor skala.&quot;</li><li>Lagt till information om att Adobe ännu en gång utnämnts till ledare i Gartners Magic Quadrant for Personalization Engines.</li></ul> |
...
|  | [Översikt över måldokumentation](/help/r-release-notes/target-documentation.md) | Nytt ämne som beskriver olika källor för [!DNL Target]-dokumentation. |
| 23 juni | [Målmeddelanden och evenemang](/help/r-release-notes/target-announcements.md) | Ytterligare information om Adobe Target Coffee Break den 24 juni. |
...
|  | [Svarstoken](/help/administrating-target/response-tokens.md) | Lagt till information om svarstoken för trafikallokeringsmetod för [!UICONTROL Auto-Target]- och [!UICONTROL Automated Personalization]-aktiviteter. |
|  | [Skapa aktivitet](/help/c-integrating-target-with-mac/a4t/campaign-creation.md) | Lagt till information om stöd för analys för målaktiviteter (A4T) för Automatisk allokering. |
...
|  | [Enterprise-användarbehörigheter](/help/administrating-target/c-user-management/property-channel/property-channel.md) | Länk har lagts till i *kontorstid: Målsession för Premium Workspaces*. |
|  | [Versionsinformation](/help/r-release-notes/release-notes.md): 20.5.1 | Den här versionen innehåller förbättringar och korrigeringar. Du kan läsa om dem och länka till dokumentationen från versionsinformationen. Den här versionen innehåller även många dokumentationsuppdateringar i hela hjälpen. |
...
| 27 maj | [Versionsinformation för mål (prerelease)](/help/r-release-notes/target-release-notes.md) | Lagt till information om stöd för analys för målaktiviteter (A4T) för Automatisk allokering. |
...
| 21 maj | [Tillåtelselista: Hörnkantsnoder](/help/c-implementing-target/c-considerations-before-you-implement-target/allowlist-edges.md) | `mboxedge30.tt.omtrdc.net` har lagts till i listan. |
...
| 22 april | [Versionsinformation för mål (prerelease)](/help/r-release-notes/target-release-notes.md) | Nytt avsnitt har lagts till: *API-ändringar för profilbatchstatus v2 (4 maj 2020).* |
...
| 20 februari | [targetGlobalSettings()](/help/c-implementing-target/c-implementing-target-for-client-side-web/targetgobalsettings.md) | Beskrivningen för inställningen `enabled` har uppdaterats. Tillagd information för följande inställningar: `pageLoadEnabled` och `viewsEnabled`. |
|  | [Geo](/help/c-target/c-audiences/c-target-rules/geo.md) | Observera att `mboxOverride.browserIp` stöds i at.js 1.*Endast* . |
