...
|  | [Profilsynkronisering i realtid för mbox3rdPartyId](/help/c-target/c-visitor-profile/3rd-party-id.md) | Uppdaterad mening om profilsynkronisering: &quot;Uppdateringar synkroniseras med profilarkivet var 5-10:e minut.&quot; |
...
| 6 oktober | [Bygg målgrupper i [!DNL Target]](/help/c-target/c-audiences/create-audience.md) | Uppdaterad text och bilder som återspeglar den uppdaterade [!DNL Target] [!UICONTROL Audiences] Gränssnitt. Liknande förändringar har gjorts under hela [!UICONTROL Audiences] ämnen. |
...
|  | [Konfigurera företagsbehörigheter](/help/administrating-target/c-user-management/property-channel/properties-overview.md) | Ändrad `targetPageParams` till `targetPageParamsAll` i&quot;Steg 5 Uppdatera implementeringen till att inkludera `at_property` parameter.&quot; |
...
| 22 september | [Anpassa en design med Snabb](/help/c-recommendations/c-design-overview/customizing-a-template.md) | Ändrad `$Double` till `$double` i kodexempel för att förhindra eventuell tvetydighet. |
...
|  | [Implementera [!DNL Target] använda [!DNL Adobe Experience Platform]](/help/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/cmp-implementing-target-using-adobe-launch.md) | Anteckningen&quot;Fördelar med att implementera at.js med [!DNL Target] extension&quot;. |
...
|  | [at.js Frågor och svar](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-atjs-faq/target-atjs-faq.md#section_74527E3B41B54B0A83F217C3E664ED1F) | Uppdaterade följande frågor och svar: &quot;Varför använder inte at.js alltid flaggorna HTTPOnly och Secure cookie?&quot; |
...
|  | [Klassificeringar - A4T - vanliga frågor och svar](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-classifications.md) | Uppdaterad information om `targettype` och `algorithmId`, som är interna identifierare som används av [!UICONTROL Auto-Allocate] och [!UICONTROL Auto-Target] verksamhet. |
...
| 16 augusti | [Versionsinformation för mål (aktuell)](/help/r-release-notes/release-notes.md)<br>och<br>[versionsinformation för at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) | Versionsinformation för at.js 2.6.1 har lagts till. |
...
| 11 augusti | [Versionsinformation för mål (aktuell)](/help/r-release-notes/release-notes.md) | Versionsinformation för [!DNL Target] node.js SDK version 2.2.0. |
...
| 5 augusti | [Versionsinformation för mål (aktuell)](/help/r-release-notes/release-notes.md) | Anteckning som anger att [!DNL Target Standard/Premium] 18.8.1-versionen är fördröjd. |
|  | [[!UICONTROL Auto-Allocate] översikt](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md#change-reporting) | Följande frågor och svar har lagts till:<ul><li>Kan jag ändra rapporteringskällan halvvägs genom en [!UICONTROL Auto-Allocate] aktivitet?</li></ul> |
| 4 augusti | [targetGlobalSettings()](/help/c-implementing-target/c-implementing-target-for-client-side-web/targetgobalsettings.md) | Lagt till information om `optinEnabled` inställning. |
| 3 augusti | [Versionsinformation för mål (aktuell)](/help/r-release-notes/release-notes.md) | Lagt till information om [!UICONTROL Target Delivery API] release. |
|  | [Versionsinformation för mål (prerelease)](/help/r-release-notes/target-release-notes.md) | Lagt till information om kommande [!DNL Target Standard/Premium] 21.8.1 (4 augusti 2021). |
...
|  | [Versionsinformation för mål (prerelease)](/help/r-release-notes/target-release-notes.md) | Lagt till information om kommande [!UICONTROL Target Delivery API] release. |
...
| 29 juli | [Målmeddelanden och evenemang](/help/r-release-notes/target-announcements.md) | Lagt till information om [!DNL Adobe Target] Community Q&amp;A Coffee Break: Onsdagen den 11 augusti 2021. |
...
| 16 juli | [Versionsinformation för mål (aktuell)](/help/r-release-notes/release-notes.md)<br>och<br>[versionsinformation för at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) | Ytterligare information om at.js 2.6.0. |
...
|  | [adobe.target.getOffers() - at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Uppdaterad beskrivning av `consumerId` nyckel. |
...
|  | [Anpassa en global mbox](/help/c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/c-understanding-global-mbox/customize-global-mbox.md) | Uppdaterat steg 1 för att ange att ändringen sparas automatiskt när du har valt en ny mbox. |
|  | Experience Cloud Device Co-op | Avsnittet har tagits bort. Den här funktionen har tagits bort. |
| 29 juni | [Aktivitets-QA](/help/c-activities/c-activity-qa/activity-qa.md) | Följande avsnitt har lagts till:<ul><li>JavaScript-målbibliotek [!UICONTROL QA Mode] kompatibilitet</li><li>Förhandsgranska URL:er</li></ul> |
| 24 juni | [Versionsinformation för mål (prerelease)](/help/r-release-notes/target-release-notes.md) | Förhandsversionsinformationen för [!DNL Target Standard/Premium] 21.6.1-utgåvan (30 juni 2021). |
| 16 juni | [[!DNL Target] versionsinformation (aktuell)](/help/r-release-notes/release-notes.md) | Lagt till information om [!DNL Adobe Target] Python SDK version 1.0.0. |
|  | [Insikter om personalisering - rapporter](/help/c-reports/c-personalization-insights-reports/personalization-insights-reports.md) | Följande frågor och svar har lagts till:<ul><li>Hur lång tid tar data? [!UICONTROL Automated Personalization] (AP) och [!UICONTROL Auto-Target] finns det fortfarande modeller?</li></ul> |
| 8 juni | [Innan du implementerar Analytics för Target (A4T) med at.js](/help/c-integrating-target-with-mac/a4t/before-implement.md) | En anteckning som anger att at.js 1.8.0 eller senare inte längre fungerar med API-versioner för Visitor som är äldre än 2.5.0 för att skickas [!DNL Adobe Audience Manager] (AAM) parametrar. |
|  | [Miljö](/help/administrating-target/environments.md) | Anteckning har lagts till som anger att om du anger [!UICONTROL Active and Inactive Activities], värdar från den här miljön visar också inaktiva aktiviteter. |
|  | [Kända problem och lösta problem](/help/r-release-notes/known-issues-resolved-issues.md) | Följande kända fel har lagts till:<ul><li>[!DNL Adobe Experience Platform] segmentnamn inte visas i [!UICONTROL Important Attributes] rapport.</li></ul> |
...
|  | [Analyser för [!DNL Target] implementering](/help/c-integrating-target-with-mac/a4t/a4timplementation.md#platform) | Nytt avsnitt har lagts till:<ul><li>Implementeringssteg för en [!DNL Adobe Experience Platform Web SDK] implementering</li></ul> |
...
|  | [Svarstoken](/help/administrating-target/response-tokens.md) | Lagt till information om att använda svarstoken med [!DNL Adobe Experience Platform Web SDK].<br>**Anteckning**: Den här funktionen kommer att lanseras i en framtida version av Platform Web SDK (datum som ska fastställas). |
...
| 27 maj | [Gränser](/help/r-troubleshooting-target/target-limits.md) | Tillagt avsnitt för [!DNL Target] API-anrop. Gränsen är 50 anrop per minut. |
| 20 maj | [Enhetsbeslut](/help/c-implementing-target/c-api-and-sdk-overview/on-device-decisioning.md) | Länk har lagts till i följande blogginlägg på Adobe Tech Blog:<ul><li>Adobe Tech Blog - Del 2: Kör [!DNL Adobe Target] NodeJS SDK för experiment och personalisering på edge-plattformar (AWS Lambda@Edge)</li></ul> |
|  | [Kända problem och lösta problem](/help/r-release-notes/known-issues-resolved-issues.md) | Följande kända fel har lagts till: &quot;Arkivering [!UICONTROL Auto Target] aktiviteter kan orsaka synkroniseringsproblem.&quot; |
| 17 maj | [Versionsinformation för mål (aktuell)](/help/r-release-notes/release-notes.md) | Ytterligare information om at.js 2.5.0. |
|  | [Aktivitets-QA](/help/c-activities/c-activity-qa/activity-qa.md) | Uppdaterat ämne som indikerar att det finns förhandsgranskningslänkar för [!UICONTROL Automated Personalization] (AP) aktiviteter med at.js 2.5.0 (och senare). |
...
| 27 april | [Cookie-inställningar](/help/c-implementing-target/c-implementing-target-for-client-side-web/atjs-cookies.md) | Uppdaterat ämne för att ange att cookie-koden är giltig (`deviceIdLifetime` inställning) kan åsidosättas i version 2.3.1 eller senare av at.js. |
...
|  | [adobe.target.getOffers() - at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Följande har lagts till:<ul><li>Information om `decisioningMethod` nyckel.</li><li>Ett exempel på&quot;getCallOffers() för att fatta ett beslut på enheten&quot;.</li></ul> |
...
|  | [Geo](/help/c-target/c-audiences/c-target-rules/geo.md) | Ytterligare information om at.js 2.*x* under&quot;Hur kan jag testa mina aktiviteter som om jag är en användare som kommer från en annan plats?&quot; |
...
|  | [Tillåtelselista: Hörnkantsnoder](/help/c-implementing-target/c-considerations-before-you-implement-target/allowlist-edges.md) | Uppdaterat [!DNL Target] IP-adresser för edge. |
...
|  | [Gränser](/help/r-troubleshooting-target/target-limits.md) | Uppdaterad text för `productPurchasedID` parameter. |
