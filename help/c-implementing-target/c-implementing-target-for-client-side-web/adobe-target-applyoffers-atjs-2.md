...
description: Information om funktionen adobe.target.applyOffers(options) för JavaScript-biblioteket för Adobe Target at.js.
title: Information om funktionen adobe.target.applyOffers(options) för JavaScript-biblioteket för Adobe Target at.js.
