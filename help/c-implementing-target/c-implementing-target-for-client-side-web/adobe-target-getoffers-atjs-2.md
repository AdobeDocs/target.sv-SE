...
description: Använd funktionen adobe.target.getOffers() och dess alternativ för Adobe [!DNL Target] at.js library to fire requests to get multiple [!DNL Target] erbjudanden. (at.js 2.x)
