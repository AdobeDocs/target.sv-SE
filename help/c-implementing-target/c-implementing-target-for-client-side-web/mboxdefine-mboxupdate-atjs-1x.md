...
description: Använd funktionerna mboxDefine() och mboxUpdate() för JavaScript-biblioteket för Adobe Target at.js för att definiera eller uppdatera en mbox. (at.js 1.x)
