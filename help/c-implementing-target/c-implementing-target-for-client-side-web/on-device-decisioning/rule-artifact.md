---
keywords: implementering;javascript-bibliotek;js;atjs;on device decisioning;on device decisioning;rule artifact
description: Läs mer om JSON-regelartefakten som används vid enhetsbeslut.
