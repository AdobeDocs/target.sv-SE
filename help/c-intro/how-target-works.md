...
description: Adobe Target kan integreras med webbplatser genom ett av två JavaScript-bibliotek. at.js eller mbox.js
...
Adobe Target kan integreras med webbplatser med hjälp av ett av två JavaScript-bibliotek: at.js eller mbox.js
...
Du måste referera till JavaScript-målbiblioteksfilen på alla sidor på webbplatsen. Du kan till exempel lägga till den i det globala sidhuvudet. Du kan också överväga att använda [tagghanteraren Adobe Launch](/help/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/cmp-implementing-target-using-adobe-launch.md)
...
Mer information finns i [Automatiserad personalisering](../c-activities/t-automated-personalization/automated-personalization.md#task_8AAF837796D74CF893CA2F88BA1491C9) .

Automated Personalization (AP) kombinerar erbjudanden och meddelanden och använder avancerad maskininlärning för att matcha olika erbjudandevariationer för varje besökare baserat på deras individuella kundprofil, för att personalisera innehåll och driva lyft.
...
Mer information finns i [Rekommendationer](../c-recommendations/recommendations.md#concept_7556C8A4543942F2A77B13A29339C0C0) .
...
Källan till den här bilden är faktabladet om [Adobe Target Security Overview](https://www.adobe.com/content/dam/acom/en/security/pdfs/AdobeTargetSecurityOverview.pdf) .

Adobe Target-lösningen finns på datacenter som ägs av Adobe och som hyrs av Adobe över hela världen. Administratörsservrar ligger helt och hållet på datacenter som ägs av Adobe i London, Singapore och på olika platser i USA, inklusive Oregon och Virginia. Edge-servrar lagras både på Adobe-ägda och Adobe-leasade servrar i Amazon AWS-datacenter i London, Hong Kong SAR i Kina, Singapore, Tokyo och Sydney.
...
Om du vill kan du tillåta kantanteckningar i Target. Mer information finns i [allowlist Target edge nodes](/help/c-implementing-target/c-considerations-before-you-implement-target/allowlist-edges.md).
...
Adobe skyddar användarupplevelsen genom att optimera och skydda prestandan.

* Adobe säkerställer prestandatester baserade på branschstandarder som garanteras av Adobe Service Level Agreement.
* Edge Network ger snabb leverans av data.
* Adobe har en strategi där flera nivåer används för att säkra sina applikationer och ge kunderna högsta tillgänglighet och tillförlitlighet.
...
* Använd robottrafik för att modellera och leverera personaliserat innehåll för aktiviteter som Rekommendationer, Automatiskt mål, Automatiserad personalisering eller Automatisk allokering
* Logga ett aktivitetsbesök för rapportering
* Logga data som ska skickas till Adobe Experience Cloud-plattformen
