...
| Pitfall | Lösning |
| --- | --- |
| Inte tillräckligt med trafik för att uppnå statistiskt signifikanta resultat. | Använd Adobe Target [beräkningsverktyg för exempelstorlek](https://experienceleague.adobe.com/tools/calculator/testcalculator.html) för att förstå hur lång tid testet måste ta och sedan köra testet tills det är klart. |
...
| En aktivitet före resultaten är statistiskt signifikant. | Verifiera testets varaktighet med Adobe [beräkningsverktyget för samplingsstorlek](https://experienceleague.adobe.com/tools/calculator/testcalculator.html). |
