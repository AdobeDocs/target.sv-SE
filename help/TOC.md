   ...
   + Webben på klientsidan: implementera mål {#client-side}
      ...
      + at.js-implementering {#at-js-implementation}
         + Enhetsbeslut {#on-device-decisioning}
            ...
            + [Felsökning](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/troubleshooting-on-device-decisioning.md)
...
+ Integrera Target med Experience Cloud {#integrate}
   ...
   + [Experience Cloud målgrupper](/help/c-integrating-target-with-mac/mmp.md)
...
+ Recommendations {#recommendations}
   ...
   + Kriterier {#criteria}
      ...
      + [Forskningen bakom Target:s rekommendationsalgoritmer](/help/c-recommendations/c-algorithms/recommendations-algorithms.md)
