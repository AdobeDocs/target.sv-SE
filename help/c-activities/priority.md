...
description: Adobe Target avgör vilken aktivitet (eller vilka aktiviteter) som ska levereras till en sida på olika sätt beroende på vilket Target-gränssnitt och vilken aktivitetsskapande funktion (Visual Experience Composer eller Form Based Composer) du använder.
...
Target avgör vilken eller vilka aktiviteter som ska levereras till en sida på olika sätt beroende på vilket Target-gränssnitt och vilken aktivitetsskapande funktion (Visual Experience Composer eller Form Based Composer) du använder.
...
1. Target serveranrop kommer till Target med information om URL:en.
1. Target hämtar alla aktiviteter som körs på den URL:en.
1. Target försöker matcha besökaren med aktiviteter.
...
1. Om innehållet för varje aktivitet refererar till olika [CSS-väljare](../c-experiences/c-visual-experience-composer/vec-selectors.md#concept_4EB7663E255F439B8D24079D23479337)visas allt innehåll.
...
1. Target serversamtal kommer till Target med information om [!DNL Target] förfrågan och URL:en.
...
1. Om en Visual Experience Composer-aktivitet har högst prioritet returneras innehåll från alla matchande aktiviteter i Visual Experience Composer, men inget Target Classic- eller formulärbaserat aktivitetsinnehåll returneras.
...
## Target Standard/förstklassig formulärbaserad disposition med icke-globala Target-förfrågningar {#section_C3F5F09B0B2D4EF795C5929D5C426A8C}
...
>[!NOTE]
>
>Beroende på dina inställningar varierar prioritetsvärdena. Du kan använda de äldre inställningarna Låg, Medel eller Hög, eller aktivera finkorniga prioriteringar mellan 0 och 999. Mer information finns i [Aktivitetsinställningar](../c-activities/activity-settings.md#task_C6B2FF8374724933BE79A83549B9CD02).

**Två Target Classic-kampanjer använder icke-globala Target-förfrågningar**
...
>[!NOTE]
>
>Detta är samma svar som i det andra användningsfallet ovan eftersom Target Classic inte hanterar väljarkollisioner. Target Standarden fångar upp sådant beteende och andra användningsfall när väljare kan kollidera både i DOM och visuellt (vanligtvis på upplevelseredigerarnivå eller i kampanjsimuleringsläge).
