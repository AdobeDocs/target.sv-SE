...
## Använd endast Visual Experience Composer som standard/Premium eller formulärbaserad disposition med enbart global mbox {#section_4A0A317DFED345649B58B0CB5B410C8B}
...
1. Målserveranropet kommer till Target med information om mbox och URL.
1. Target Classic och Standard drar alla aktiviteter som körs i den rutan.
1. Målförsök att matcha besökaren med aktiviteter.
...
Om du har två aktiviteter, den ena med nyckelordet Nike som målgrupp och den andra med nyckelordet som inte är varumärkesprofilerade, kontrolleras prioriteten för båda aktiviteterna. Om Nike-aktiviteten har högre prioritet visas det innehållet. Om nekare-aktiviteten har högre prioritet visas dess innehåll.
...
## Målstandarddisposition/förstklassig formulärbaserad disposition med icke-globala rutor {#section_C3F5F09B0B2D4EF795C5929D5C426A8C}

>[!NOTE]
>
>Den här informationen gäller även alla kampanjer som körs och som har skapats i Target Classic.

Om ditt företag använder andra kryssrutor än den globala mbox i den formulärbaserade dispositionen kan innehåll från endast en aktivitet returneras per anrop. Aktivitetsleveransen bestäms med hjälp av följande beslutsflöde:

1. Målserveranropet kommer till Target med information om mbox och URL.
1. Målet hämtar alla aktiviteter som körs i den rutan.
1. Målförsök att matcha besökaren med den högsta prioritetsaktiviteten.
...
**Två Target Classic-kampanjer använder icke-globala kryssrutor**
