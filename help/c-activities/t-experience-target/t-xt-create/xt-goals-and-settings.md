...
Mer information om att ställa in mått finns i [Ange mått](../../../c-activities/t-test-ab/t-test-create-ab/ab-set-metrics.md#task_A04AB66007C1467DA1C21A519A5C7BEB) .
...
Den här inställningen är inte tillgänglig om du väljer Analytics som rapporteringslösning. De målgrupper som definieras för Analytics rapporteringsprogram används.
