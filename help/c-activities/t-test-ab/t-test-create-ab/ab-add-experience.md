...
description: Visual Experience Composer (VEC) i Adobe Target är ett visuellt gränssnitt för att redigera upplevelserna på din sida.
...
1. Markera elementen som du vill ändra och gör önskade ändringar.
   ...
   Om du har skapat en mbox på sidan med Target Classic (tidigare Test&amp;Target), visas den mbox som ett element som visar mbox-namnet och kan ändras precis som andra element.
