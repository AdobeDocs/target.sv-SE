...
>[!NOTE]
>
>Förutom [!UICONTROL Auto-Allocate][!UICONTROL A/B Test] aktiviteten (som diskuteras i den här artikeln) finns det två typer av [!DNL Target] ytterligare [!UICONTROL A/B Test] aktiviteter: [!UICONTROL Manual (Default)] och [!UICONTROL Auto-Target].
>
