...
# ![PREMIUM](/help/assets/premium.png) Viktiga attributrapporter
...
>
>* [!UICONTROL Personalization Insights] rapporter stöds i [standardmiljö](/help/administrating-target/hosts.md) endast.
>
...
1. Klicka **[!UICONTROL Activities]** och klickar sedan på [Automated Personalization](/help/c-activities/t-automated-personalization/automated-personalization.md#task_8AAF837796D74CF893CA2F88BA1491C9) eller [Automatiskt mål](/help/c-activities/auto-target/auto-target-to-optimize.md) från listan.
...
1. (Valfritt) [Ladda ned rapporten i CSV-format](/help/c-reports/c-report-settings/report-settings.md#section_77E65C50BAAF4AB79242DB3A8778ADEF) för analys i Excel och andra verktyg.
...
* Din aktivitet har inte haft tillräckligt med trafik under den angivna tidsramen. Efter 15 dagar har passerat, förutsatt att det finns [tillräcklig personlig trafik](/help/c-activities/auto-target/auto-target-to-optimize.md#section_BA4D83BE40F14A96BE7CBC7C7CF2A8FB) i din aktivitet för att skapa personaliseringsmodeller kommer rapporter om automatiserade segment och viktiga attribut att finnas tillgängliga.
