...
>[!NOTE]
>
>Den här funktionen är endast tillgänglig när du visar rapporter i [!UICONTROL Table] Visa. Den här funktionen är inte tillgänglig för aktiviteter som använder [Analyser som rapportkälla (A4T)](/help/c-integrating-target-with-mac/a4t/a4t.md#concept_7540C8C04259434AB6EE33B09F47A1DE).
...
Ladda ned [Konfidensintervall för Lyft PDF-fil](/help/assets/confidence_interval_lift.pdf) för mer information.
