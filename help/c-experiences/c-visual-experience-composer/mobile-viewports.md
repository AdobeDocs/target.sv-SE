...
| Tredje och fjärde generationen iPad | 768 x 1 024 | 1 536 x 2 048 |
...
Spara dina CSS-brytpunkter i [!DNL Target] så att du kan förhandsgranska upplevelserna för varje vy du definierar. Var och en av dessa upplevelser visas i en mobilvisningsruta i gränssnittet [!DNL Target]. Öppna vyn för varje skärmstorlek genom att klicka på visningsrutan längst upp på skärmen.
...
1. Klicka på **[!UICONTROL Add]** i **[!UICONTROL Mobile viewports configuration]**-avsnittet.
...
1. (Valfritt) Välj operativsystem för enheten.
   ...
   * Blackberry
   ...
   Om du använder [Förbättrad Experience Composer](/help/c-experiences/experiences.md#section_34265986611B4AB8A0E4D6ACC25EF91D) och väljer ett operativsystem emulerar [!DNL Target] den enheten när du visar sidan. Om det till exempel finns ett annat utseende och en annan känsla för Android än för iOS på den responsiva webbplatsen, härmar [!DNL Target] beteendet.
