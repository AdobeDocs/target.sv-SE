...
description: Lär dig hur du ställer in sekvenser på upp till fem villkor för att få bättre kontroll över objekten som visas i dina Recommendations-aktiviteter i Adobe [!DNL Target] .
