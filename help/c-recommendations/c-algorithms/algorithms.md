...
>[!NOTE]
>
>Funktionen [!UICONTROL Algorithm Usage] stöds för närvarande endast för rekommendationer. Den här funktionen stöds för närvarande inte för A/B Test- och Experience Targeting-aktiviteter (XT) som innehåller [rekommendationer som ett erbjudande](/help/c-recommendations/recommendations-as-an-offer.md).
