...
| Integrering av AEM 6.2 (eller senare)-molntjänst | Ja | Mer information finns i [Integrera med Adobe Target](https://helpx.adobe.com/experience-manager/6-2/sites/administering/using/target.html) i dokumentationen för [!DNL Adobe Experience Manager] 6.2. |
