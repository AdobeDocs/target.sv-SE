...
description: Adobe "Analytics for Target" (A4T) är en integrerad lösning som gör att ni kan skapa aktiviteter baserat på Analytics konverteringsstatistik och målgruppssegment. Tack vare den här integreringen kan du använda Analytics-rapporter för att undersöka dina resultat. Om du använder Analytics som rapportkälla för en aktivitet, baseras all rapportering och segmentering för den aktiviteten på Analytics datainsamling.
...
* När du använder A4T är alla framgångsmått som är tillgängliga för dina aktiviteter [!DNL Analytics] mätvärden. Måttet för ditt mål kan dock baseras på ett mbox-anrop. Du kan till exempel använda Target färdiga klickspårningsfunktioner med A4T i stället för att behöva implementera [!DNL Analytics] klickspårningskod.
...
* Ett server-till-server-anrop från [!DNL Target] till [!DNL Analytics] skickar aktivitets- och upplevelseinformation till [!DNL Analytics]. Den här integreringen resulterar inte i ytterligare serveranrop för antingen [!DNL Target] eller [!DNL Analytics].
   ...
   I vissa situationer kan klassificeringsanropet från [!DNL Target] till [!DNL Analytics] misslyckas och aktiviteterna visar inte data i [!DNL Analytics]. Om detta händer ska du läsa [Felsöka integreringen mellan Analytics och Target (A4T)](/help/c-integrating-target-with-mac/a4t/c-a4t-troubleshooting/a4t-troubleshooting.md). Du kan också [kontakta kundtjänst](/help/cmp-resources-and-contact-information.md#concept_34A1CA16F2244D42930BB77846A5ABBB) om du behöver mer hjälp.
...
| A/B-aktivitet med automatisk fördelning | Ja | Se [Stöd för Automatisk allokering av aktiviteter](/help/c-integrating-target-with-mac/a4t/campaign-creation.md#a4t-aa)i Analytics for Target (A4T). |
| A/B-aktivitet med Auto-Target | Nej |  |
...
| Integrering av AEM 6.1-Cloud Service (eller tidigare) | Nej |  |
| Integrering av AEM 6.2-Cloud Service (eller senare) | Ja | Mer information finns i [Integrera med Adobe Target](https://helpx.adobe.com/experience-manager/6-2/sites/administering/using/target.html) i dokumentationen till [!DNL Adobe Experience Manager] 6.2. |
...
### Analytics för Target (A4T) (4:32) ![Översikt, märke](/help/assets/overview.png)
...
### Analytics/Target Integration (A4T) (40:33) - ![självstudiemärke](/help/assets/tutorial.png)
...
* Läs om de idealiska rapporterna för Analytics
* Svar på vanliga frågor om A4T

[Kontorstimmar för integrering av Analytics/Target (A4T)](https://helpx.adobe.com/customer-care-office-hours/target/analytics-target-A4T-integration.html)