...
Om klassificeringen gjordes för den aktiviteten, och du fortfarande ser en&quot;ospecificerad&quot; rad i rapporten, kontrollerar du att rapporten inte använder ett icke-målmått för att visa data.
Om rapporten inte använder ett Target-specifikt mått kommer den &quot;unspecified&quot;-raden att innehålla händelser för anrop som inte är associerade med Target.
